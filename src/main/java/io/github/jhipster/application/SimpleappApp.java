...
public class SimpleappApp {

    private static final Logger log = LoggerFactory.getLogger(SimpleappApp.class);

    private final Environment env;

    public SimpleappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes simpleapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SimpleappApp.class);
